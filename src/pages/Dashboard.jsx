...
//   ],
//   revenue_chart: [
//     { day: "2026-05-11T00:00:00.000Z", revenue: "224.00" },
//     { day: "2026-05-15T00:00:00.000Z", revenue: "194.00" }
//   ],
//   recent_disputes: [
//     {
//       order_no: "ORD767816",
...
//       created_at: "2026-04-14T05:10:02.000Z"
//     }
//   ]
// };
...
//   const completionRate = dashboardData.summary.total_orders > 0
//     ? ((dashboardData.summary.delivered_orders / dashboardData.summary.total_orders) * 100).toFixed(1)
//     : 0;
...
//       subValue: `${dashboardData.summary.active_orders} Active`,
...
//     {
//       title: 'Active Hubs',
//       value: dashboardData.summary.total_hubs,
//       subValue: `${dashboardData.hubs.filter(h => h.status === 0).length} Active`,
...
//     {
//       title: 'Delivery Boys',
//       value: dashboardData.summary.delivery_boys,
...
//                 {dashboardData.summary.city_name}
//               </h1>
//             </div>
...
//             <p className="text-2xl font-bold text-blue-600">{dashboardData.summary.total_orders}</p>
//             <p className="text-xs mt-1 text-gray-600">Total Orders</p>
//           </div>
//           <div className="text-center p-4 rounded-xl bg-green-50">
//             <p className="text-2xl font-bold text-green-600">{dashboardData.summary.delivered_orders}</p>
//             <p className="text-xs mt-1 text-gray-600">Delivered</p>
//           </div>
//           <div className="text-center p-4 rounded-xl bg-orange-50">
//             <p className="text-2xl font-bold text-orange-600">{dashboardData.summary.active_orders}</p>
//             <p className="text-xs mt-1 text-gray-600">In Progress</p>
//           </div>
//           <div className="text-center p-4 rounded-xl bg-red-50">
//             <p className="text-2xl font-bold text-red-600">{dashboardData.summary.pending_orders}</p>
...
//                 <div className="flex-1">
//                   <h3 className="font-semibold text-sm" style={{ color: Colors.textBlack }}>
//                     {hub.hub_name}
//                   </h3>
...
//               </div>
//             ))}
//             {dashboardData.revenue_chart.length === 0 && (
