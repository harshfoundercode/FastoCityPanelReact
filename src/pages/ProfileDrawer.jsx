...
export const ProfileDrawer = ({ isOpen, onClose }) => {
  const { profileData, isLoading, error, fetchProfile } =
    useProfileViewModel();
      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-2 items-center">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs font-semibold text-gray-800 mt-0.5 break-all">
              {value || "N/A"}
            </p>
          </div>
        </div>
        ...
        {/* Verified */}
        {verified && (
          <div className="bg-green-100 text-green-700 text-[9px] font-semibold px-2 py-0.5 rounded-full shrink-0">
            Verified
          </div>
        )}
      </div>
              ...
              <div className="relative z-10 bg-gradient-to-br from-[#166534] to-[#14532D] px-4 pt-4 pb-4 overflow-hidden">
                ...
                {error && !isLoading && !profileData && (
                  <div className="flex flex-col items-center justify-center py-6 relative z-10">
                    ...
                    <button
                      onClick={() => fetchProfile()}
                      className="px-3 py-1.5 bg-white/20 text-white rounded-lg text-xs font-medium hover:bg-white/30 transition-all"
                    >
                      Try Again
                    </button>
                  </div>
                ...
                {profileData && (
                  <div className="flex items-center gap-3 mt-2 relative z-10">
                    {/* Avatar */}
                    <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[#166534] text-xl font-bold shadow-lg">
                      {profileData.name?.charAt(0)?.toUpperCase() || "U"}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1 inline-flex items-center px-2 py-0.5 rounded-full bg-white/20 backdrop-blur-md">
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 p-3 shadow-sm">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <h4 className="text-sm font-bold text-gray-800 mt-1 capitalize">
                            {profileData.address || "N/A"}
                          </h4>
                        </div>
